...
export type RehabLineItem = { category: string; subtotal: number };

export type RehabTotals = {
  subtotal: number;
...
export type RehabCostBreakdown = {
  items: RehabLineItem[];
  totals: RehabTotals;
};
 ...
 */
export function computeRehabCost(inp: RehabInputs, localFactor = 1.0): RehabCostBreakdown {
